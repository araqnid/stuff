...
public class RequestActivityTest {
	...
	private final ActivityEventSink<ActivityRequestType, ActivityEventType> activityEventSink = new CaptureEvents(activityEventsOutput);
	private final RequestActivity<ActivityRequestType, ActivityEventType> activity = new RequestActivity<>(ruid, activityEventSink);

	@Test
	public void can_begin_a_request() {
		ActivityRequestType type = randomRequestType();
	...
	public void can_add_an_event_to_a_request() {
		...
		ActivityEventType eventType = randomEventType();
	...
	public void can_finish_a_request() {
		ActivityRequestType requestType = randomRequestType();
	...
	private static ActivityRequestType randomRequestType() {
		return randomEnumInstance(ActivityRequestType.class);
	}

	private static ActivityEventType randomEventType() {
		return randomEnumInstance(ActivityEventType.class);
	}

	private static ActivityRequestType notThis(ActivityRequestType value) {
		return randomOtherInstanceOfEnum(ActivityRequestType.class, value);
	}

	private static ActivityEventType notThis(ActivityEventType value) {
		return randomOtherInstanceOfEnum(ActivityEventType.class, value);
	}
	...
	public static final class BeginRequestMatcher extends EventMatcher {
		...
		public BeginRequestMatcher with_type(ActivityRequestType value) {
			attributesMatcher.match("type", Matchers.equalTo(value));
			return this;
		}

		public BeginRequestMatcher where_type_is(Matcher<? super ActivityRequestType> matcher) {
	...
	public static final class BeginEventMatcher extends EventMatcher {
		...
		public BeginEventMatcher with_type(ActivityEventType value) {
			attributesMatcher.match("type", Matchers.equalTo(value));
			return this;
		}

		public BeginEventMatcher where_type_is(Matcher<? super ActivityEventType> matcher) {
			attributesMatcher.match("type", matcher);
			return this;
		}
	...
	public static final class FinishEventMatcher extends EventMatcher {
		...
		public FinishEventMatcher with_type(ActivityEventType value) {
			attributesMatcher.match("type", Matchers.equalTo(value));
			return this;
		}

		public FinishEventMatcher where_type_is(Matcher<? super ActivityEventType> matcher) {
			attributesMatcher.match("type", matcher);
			return this;
		}
	...
	public static final class FinishRequestMatcher extends EventMatcher {
		...
		public FinishRequestMatcher with_type(ActivityRequestType value) {
			attributesMatcher.match("type", Matchers.equalTo(value));
			return this;
		}

		public FinishRequestMatcher where_type_is(Matcher<? super ActivityRequestType> matcher) {
			attributesMatcher.match("type", matcher);
			return this;
		}
	...
	public static final class CaptureEvents implements ActivityEventSink<ActivityRequestType, ActivityEventType> {
		...
		@Override
		public void beginRequest(String ruid, long eventId, ActivityRequestType type, String description) {
			add("beginRequest", "ruid", ruid, "eventId", eventId, "type", type, "description", description);
		}

		@Override
		public void beginEvent(String ruid, long eventId, long parentEventId, ActivityEventType type, String description) {
			add("beginEvent", "ruid", ruid, "eventId", eventId, "parentEventId", parentEventId, "type", type,
					"description", description);
		}

		@Override
		public void finishEvent(String ruid, long eventId, long parentEventId, ActivityEventType type, long durationNanos) {
			add("finishEvent", "ruid", ruid, "eventId", eventId, "parentEventId", parentEventId, "type", type,
					"durationNanos", durationNanos);
		}

		@Override
		public void finishRequest(String ruid, long eventId, ActivityRequestType type, long durationNanos) {
