...
public class ScheduledJobControllerTest {
	...
	@SuppressWarnings("unchecked")
	private final ActivityScope.Control<AppRequestType> mockScopeControl = Mockito.mock(ActivityScope.Control.class);
	private final ActivityScope.Control<AppRequestType> scopeControl = new ActivityScope.Control<AppRequestType>() {
		@Override
